...
(function webpackUniversalModuleDefinition(root, factory) {
	if (typeof exports === 'object' && typeof module === 'object')
		...
		exports['WiReModule'] = factory(require('react'));
	else root['WiReModule'] = factory(root['React']);
		...
		/******/ [
			...
			/***/ function(module, __webpack_exports__, __webpack_require__) {
				...
				/* harmony default export */ __webpack_exports__['default'] = {
					SampleTextWidget: {
						initialise: function initialise(_ref) {
							var text = _ref.text,
								root = _ref.root;
							return react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(
								react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
									Example,
									{ text: text }
								),
...
*/
				...
				function Ea(a) {
					...
					a = Aa;
					Aa = null;
					if (a && (za(a, Ba), Aa ? t('95') : void 0, ha))
				...
				function Na(a, b, c) {
					if ((b = Da(a, c.dispatchConfig.phasedRegistrationNames[b])))
							...
							e
								? (sb &&
										...
										(yb || e !== ub.compositionStart
											...
											: ((cb = d),
											  (eb = 'value' in cb ? cb.value : cb.textContent),
											  (yb = !0))),
								  (e = mb.getPooled(e, b, c, d)),
								  f
										? (e.data = f)
										: ((f = xb(c)), null !== f && (e.data = f)),
								  Ra(e),
								  (f = e))
								: (f = null);
							(a = rb ? zb(a, c) : Ab(a, c))
								? ((b = nb.getPooled(ub.beforeInput, b, c, d)),
								  (b.data = a),
								  Ra(b))
								: (b = null);
				...
				function uc(a, b, c, d) {
					if (null === b || 'undefined' === typeof b || tc(a, b, c, d))
						return !0;
					if (d) return !1;
					if (null !== c)
						switch (c.type) {
				...
				function Rc(a, b, c) {
					'focus' === a
						? (Pc(),
						  (Jc = b),
						  (Kc = c),
						  Jc.attachEvent('onpropertychange', Qc))
						: 'blur' === a && Pc();
				}
				function Sc(a) {
				...
				function md(a) {
					...
					if (!b)
						return (
							(b = kd(a)), 3 === b ? t('188') : void 0, 1 === b ? null : a
						);
					for (var c = a, d = b; ; ) {
						var e = c.return,
				...
				function dg(a) {
					...
					function m(a, b, c, d, g) {
						if (null === b || 7 !== b.tag)
							return (b = bf(c, a.mode, d, g)), (b.return = a), b;
						b = e(b, c, d);
						b.return = a;
						return b;
					}
					function r(a, b, c) {
						...
						if ('object' === typeof b && null !== b) {
							switch (b.$$typeof) {
								case Zb:
									return (
										(c = af(b.type, b.key, b.props, null, a.mode, c)),
										(c.ref = bg(a, null, b)),
										(c.return = a),
										c
									);
					...
					return function(a, d, f, h) {
						...
						if ('undefined' === typeof f && !k)
							switch (a.tag) {
								...
								case 0:
									(h = a.type),
										t('152', h.displayName || h.name || 'Component');
							}
						return c(a, d);
					};
				}
				...
				function rg(a, b, c, d, e, f) {
					if (null === a) {
						...
						if (
							...
							return (b.tag = 15), (b.type = g), sg(a, b, g, d, e, f);
				...
				function yg(a) {
					var b = a.stateNode;
					b.pendingContext
						? Pe(a, b.pendingContext, b.pendingContext !== b.context)
						: b.context && Pe(a, b.context, !1);
				...
				function tg(a, b, c) {
					...
					if (null !== b.child) {
						...
						for (c.return = b; null !== a.sibling; )
							(a = a.sibling),
								(c = c.sibling = $e(a, a.pendingProps, a.expirationTime)),
								(c.return = b);
						c.sibling = null;
					}
					return b.child;
				...
				function Pg(a) {
					for (var b = a, c = !1, d = void 0, e = void 0; ; ) {
						...
						if (5 === b.tag || 6 === b.tag) {
							...
							(4 === b.tag
								? ((d = b.stateNode.containerInfo), (e = !0))
								: Og(b),
							null !== b.child)
						) {
							b.child.return = b;
				...
				function ph(a, b, c, d, e) {
					a.expirationTime = d;
					0 !== e || nh()
						? 0 < e && (a.timeoutHandle = De(Mh.bind(null, a, b, c), e))
				...
				function Ph(a, b, c) {
					...
					if (c) {
						...
						null !== d
							...
							: ((a.finishedWork = null),
							  (d = a.timeoutHandle),
							  -1 !== d && ((a.timeoutHandle = -1), Ee(d)),
							  mh(a, c),
							  (d = a.finishedWork),
							  null !== d && (nh() ? (a.finishedWork = d) : Sh(a, d, b)));
					} else
						(d = a.finishedWork),
							null !== d
								? Sh(a, d, b)
				...
				function Sh(a, b, c) {
					...
					if (
						...
						x &&
						x.ownerDocument &&
						Sd(x.ownerDocument.documentElement, x)
					) {
						null !== q &&
							Ud(x) &&
							((C = q.start),
				...
				function ai(a) {
					var b =
						1073741822 - 25 * ((((1073741822 - Rf() + 500) / 25) | 0) + 1);
					b >= bh && (b = bh - 1);
...
*/
			...
			/***/ function(module, exports, __webpack_require__) {
				...
				/* WEBPACK VAR INJECTION */ (function(global) {
					...
					'undefined' !== typeof window
						? (G = window)
						: 'undefined' !== typeof global && (G = global);
					if (G && G._schedMock) {
						var H = G._schedMock;
						r = H[0];
						q = H[1];
